                ...
                <div className="container mx-auto flex items-center justify-center text-center">
                    ...
                    <div className="flex w-full gap-2 md:hidden">
                        <a
                            ...
                            className="flex gap-2 bg-secondary border px-2 py-1 rounded  transition-all duration-300 hover:brightness-90 dark:hover:brightness-150"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex gap-2 bg-secondary px-2 py-1 rounded border transition-all duration-300 hover:brightness-90 dark:hover:brightness-150"
                        >
